            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{ucwords(__('cp.departments'))}}</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/admin/departments/create')}}" class="btn btn-secondary  mr-2 btn-success">
                                ...
                                <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/departments')}}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{url(app()->getLocale().'/admin/departments')}}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}
...
{{--                                        <td class="v-align-middle wd-5p"><img src="{{$one->image}}" width="50px" height="50px"></td>--}}
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/admin/departments/'.$one->id.'/edit')}}"
