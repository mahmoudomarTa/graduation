                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-custom bg-success gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <span
                                    class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 text-hover-primary d-block">{{$favorite_count}}</span>

                                <span class="font-weight-bold text-white font-size-sm">{{__('cp.favorite_count')}}</span>
