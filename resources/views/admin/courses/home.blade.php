        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/admin/courses/create')}}" class="btn btn-secondary  mr-2 btn-success">
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse" >
                            <div class="card" >
                                <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/courses')}}">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select   class="form-control select2"
                                                    ...
                                                    @foreach($departments as $one)
                                                        <option data-id="{{$one->id}}" value="{{$one->id}}" {{request('department_id')==$one->id?'selected':''}}>
                                                            {{$one->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{url(app()->getLocale().'/admin/courses')}}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}
...
{{--                                        <td class="v-align-middle wd-5p"><img src="{{$one->image}}" width="50px" height="50px"></td>--}}
                                        ...
                                        <td class="v-align-middle wd-25p">{{@$one->department->faculty->name}}</td>
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/admin/courses/'.$one->id.'/edit')}}"
