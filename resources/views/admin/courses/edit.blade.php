        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form method="post" action="{{url(app()->getLocale().'/admin/courses/'.$item->id)}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select   class="form-control form-control-solid"
                                                ...
                                                @foreach($faculties as $one)
                                                    <option data-id="{{$one->id}}" value="{{$one->id}}" {{old('faculty_id',$item->department->faculty->id)==$one->id?'selected':''}}>
                                                        {{$one->name}}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-solid" id="year_id" name="year_id"
                                                ...
                                                @foreach($years as $one)
                                                    <option data-id="{{$one->year->id}}" value="{{$one->year->id}}" {{old('year_id',$item->year_id)==$one->year->id?'selected':''}}>
                                                        {{$one->year->name}}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select   class="form-control form-control-solid"
                                                ...
                                                @foreach($semesters as $one)
                                                    <option data-id="{{$one->id}}" value="{{$one->id}}" {{old('semester_id',$item->semester_id)==$one->id?'selected':''}}>
                                                        {{$one->name}}
                                                    </option>
                                                @endforeach
                                            </select>
