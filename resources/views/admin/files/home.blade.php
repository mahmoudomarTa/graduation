        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/admin/files/create')}}" class="btn btn-secondary  mr-2 btn-success">
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse" >
                            <div class="card" >
                                <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/files')}}">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">{{__('cp.faculty')}}</label>
                                                <select id="multiple2" class="form-control"
                                                        name="faculty_id">
                                                    <option value="">{{__('cp.all')}}</option>

                                                    @foreach($faculties as $one)
                                                    <option value="{{$one->id}}" {{request('faculty_id') == $one->id?'selected':''}}>
                                                        {{$one->name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="multiple2" class="form-control"
                                                    ...
                                                    <option value="{{$one->id}}" {{request('department_id') == $one->id?'selected':''}}>
                                                        {{$one->name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">{{__('cp.course')}}</label>
                                                <select id="multiple2" class="form-control"
                                                        name="course_id">
                                                    <option value="">{{__('cp.all')}}</option>

                                                    @foreach($courses as $one)
                                                    <option value="{{$one->id}}" {{request('course_id') == $one->id?'selected':''}}>
                                                        {{$one->name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="multiple2" class="form-control"
                                                    ...
                                                    <option value="{{$one->id}}" {{request('year_id') == $one->id?'selected':''}}>
                                                        {{$one->name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">{{__('cp.semester')}}</label>
                                                <select id="multiple2" class="form-control"
                                                        name="semester_id">
                                                    <option value="">{{__('cp.all')}}</option>

                                                    @foreach($semesters as $one)
                                                    <option value="{{$one->id}}" {{request('semester_id') == $one->id?'selected':''}}>
                                                        {{$one->name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{url(app()->getLocale().'/admin/files')}}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-25p"> {{ucwords(__('cp.faculty'))}}</th>
                                    <th class="wd-25p"> {{ucwords(__('cp.department'))}}</th>
                                    <th class="wd-25p"> {{ucwords(__('cp.year'))}}</th>
                                    <th class="wd-25p"> {{ucwords(__('cp.semester'))}}</th>
                                    <th class="wd-25p"> {{ucwords(__('cp.course'))}}</th>
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-5p"><img src="{{fileImage()}}" width="50px" height="50px"></td>

                                        <td class="v-align-middle wd-25p">{{$one->name}}</td>
                                        <td class="v-align-middle wd-25p">{{@$one->faculty->name}}</td>
                                        <td class="v-align-middle wd-25p">{{@$one->department->name}}</td>
                                        <td class="v-align-middle wd-25p">{{@$one->year->name}}</td>
                                        <td class="v-align-middle wd-25p">{{@$one->semester->name}}</td>
                                        <td class="v-align-middle wd-25p">{{@$one->course->name}}</td>
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/admin/files/'.$one->id.'/edit')}}"
