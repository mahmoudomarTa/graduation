  ...
  legend {
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="{{url('logo_w.png')}}" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						...
						<a href="{{ url(app()->getLocale().'/admin/home') }}" class="brand-logo">
							<img alt="Logo" src="{{url('logo_w.png')}}" style="max-width: 90px;" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
                           ...
                           @if(can(['users-show' , 'users-create' , 'users-edit' , 'users-delete']))
							...
							@endif
                                     ...
                                     @if(can(['faculties-show' , 'faculties-create' , 'faculties-edit' , 'faculties-delete']))
                                        <li class="menu-item {{(explode("/", request()->url())[5] == "faculties") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                            <a href="{{url(getLocal().'/admin/faculties')}}" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                ...
                                                <span class="menu-text">{{__('cp.faculties')}}</span>
                                            </a>
                                        </li>
                                    @endif

                                     @if(can(['departments-show' , 'departments-create' , 'departments-edit' , 'departments-delete']))
                                        <li class="menu-item {{(explode("/", request()->url())[5] == "departments") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                            <a href="{{url(getLocal().'/admin/departments')}}" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                         <rect x="0" y="0" width="24" height="24"/>
                                                ...
                                                <span class="menu-text">{{__('cp.departments')}}</span>
                                            </a>
                                        </li>
                                    @endif

                                     @if(can(['courses-show' , 'courses-create' , 'courses-edit' , 'courses-delete']))
                                        <li class="menu-item {{(explode("/", request()->url())[5] == "courses") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                            <a href="{{url(getLocal().'/admin/courses')}}" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                         <rect x="0" y="0" width="24" height="24"/>
                                                ...
                                                <span class="menu-text">{{__('cp.courses')}}</span>
                                            </a>
                                        </li>
                                    @endif

                                     @if(can(['videos-show' , 'videos-create' , 'videos-edit' , 'videos-delete']))
                                        <li class="menu-item {{(explode("/", request()->url())[5] == "videos") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                            <a href="{{url(getLocal().'/admin/videos')}}" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                         <rect x="0" y="0" width="24" height="24"/>
                                                ...
                                                <span class="menu-text">{{__('cp.videos')}}</span>
                                            </a>
                                        </li>
                                    @endif
                                     ...
                                     @if(can(['files-show' , 'files-create' , 'files-edit' , 'files-delete']))
                                        <li class="menu-item {{(explode("/", request()->url())[5] == "files") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                            <a href="{{url(getLocal().'/admin/files')}}" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                         <rect x="0" y="0" width="24" height="24"/>
                                                ...
                                                <span class="menu-text">{{__('cp.files')}}</span>
                                            </a>
                                        </li>
                                    @endif
                                ...
                                @if(can(['courses-show' , 'courses-create' , 'courses-edit' , 'courses-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "requirements") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/requirements')}}" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                         <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="menu-text">{{__('cp.requirements')}}</span>
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if(can(['videos-show' , 'videos-create' , 'videos-edit' , 'videos-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "requirementsVideos") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/requirementsVideos')}}" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                         <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="menu-text">{{__('cp.requirementsVideos')}}</span>
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if(can(['files-show' , 'files-create' , 'files-edit' , 'files-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "requirementsFiles") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/requirementsFiles')}}" class="menu-link">
                                                <span class="svg-icon menu-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                         <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="menu-text">{{__('cp.requirementsFiles')}}</span>
                                        </a>
                                    </li>
                                @endif
...
{{--									 <li class="menu-item {{(explode("/", request()->url())[5] == "partners") ? "menu-item-here" : ''}}" aria-haspopup="true">--}}
{{--										 <a href="{{url(getLocal().'/admin/partners')}}" class="menu-link">--}}
{{--											<span class="svg-icon menu-icon">--}}
{{--												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">--}}
{{--												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--													 <rect x="0" y="0" width="24" height="24"/>--}}
...
{{--											    </svg>--}}
{{--											 </span>--}}
{{--											 <span class="menu-text">{{__('cp.partners')}}</span>--}}
{{--										 </a>--}}
{{--									  </li>--}}
{{--									  @endif--}}
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							<div class="text-dark order-2 order-md-1">
								<span class="text-muted font-weight-bold mr-2">{{date("Y")}}'&copy; محاضرات الطالب الجامعي'</span>
